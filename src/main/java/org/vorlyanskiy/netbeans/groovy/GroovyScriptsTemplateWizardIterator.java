...
public class GroovyScriptsTemplateWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {
    ...
    public GroovyScriptsTemplateWizardIterator() {
    }

    public static GroovyScriptsTemplateWizardIterator createIterator() {
        return new GroovyScriptsTemplateWizardIterator();
    }

    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
            new GroovyScriptsTemplateWizardPanel(),};
    }

    private String[] createSteps() {
        return new String[]{
            NbBundle.getMessage(GroovyScriptsTemplateWizardIterator.class, "LBL_CreateProjectStep")
        };
    }
